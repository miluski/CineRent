    ...
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6 animate-in fade-in-0 slide-in-from-bottom-4 duration-500 fill-mode-backwards">
          ...
          {dvdData && (
            <Pagination
              currentPage={dvdData.currentPage}
              totalPages={dvdData.totalPages}
              totalElements={dvdData.totalElements}
              pageSize={dvdData.pageSize}
              hasNext={dvdData.hasNext}
              hasPrevious={dvdData.hasPrevious}
